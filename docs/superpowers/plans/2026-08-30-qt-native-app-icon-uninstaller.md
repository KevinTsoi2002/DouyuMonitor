...
**Architecture:** 用版本库中的 SVG 设计源生成多尺寸 `.ico`。CMake 将该资源嵌入主程序与无控制台的 C++ 卸载器；安装脚本复制卸载器、创建卸载快捷方式并登记当前用户卸载项。卸载器确认后清理用户入口、登记项和安装目录。
...
- [ ] **Step 3: 清理临时安装、运行 Release CTest 和文档校对**
