...
$installLines = @(
    ...
    'New-Item -Path $uninstallRegistryPath -Force | Out-Null; New-ItemProperty -Path $uninstallRegistryPath -Name ''DisplayName'' -Value ''DouyuMonitor'' -PropertyType String -Force | Out-Null; New-ItemProperty -Path $uninstallRegistryPath -Name ''DisplayVersion'' -Value ''0.2.2'' -PropertyType String -Force | Out-Null; New-ItemProperty -Path $uninstallRegistryPath -Name ''Publisher'' -Value ''DouyuMonitor'' -PropertyType String -Force | Out-Null; New-ItemProperty -Path $uninstallRegistryPath -Name ''InstallLocation'' -Value $target -PropertyType String -Force | Out-Null; New-ItemProperty -Path $uninstallRegistryPath -Name ''DisplayIcon'' -Value $iconPath -PropertyType String -Force | Out-Null; New-ItemProperty -Path $uninstallRegistryPath -Name ''UninstallString'' -Value (''"{0}"'' -f $uninstaller) -PropertyType String -Force | Out-Null; New-ItemProperty -Path $uninstallRegistryPath -Name ''NoModify'' -Value 1 -PropertyType DWord -Force | Out-Null; New-ItemProperty -Path $uninstallRegistryPath -Name ''NoRepair'' -Value 1 -PropertyType DWord -Force | Out-Null',
